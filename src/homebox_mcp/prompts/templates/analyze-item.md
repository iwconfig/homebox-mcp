...
| Diagonal (Downhill: Top-Left to Bottom-Right) | 45° |
| Vertical (Top-to-Bottom) | 90° |
| Diagonal (Steep Reverse: Top-Right to Bottom-Left) | 135° |
| Horizontal (Right-to-Left) | 180° |
| Diagonal (Uphill Reverse: Bottom-Right to Top-Left) | 225° |
| Vertical (Bottom-to-Top) | 270° |
| Diagonal (Uphill: Bottom-Left to Top-Right) | 315° |
...
*   **Text Analysis**:
    ...
    *   *Direction*: [e.g., Vertical (Bottom-to-Top)]
*   **Rotation Logic**:
