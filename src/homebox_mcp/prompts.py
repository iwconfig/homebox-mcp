...
def register_prompts(mcp: FastMCP):
    ...
    async def analyze_item_prompt(item_id: str = "") -> str:
        ...
        return (
            ...
            "4. **Orientation Precision**: Items must be perfectly level. Positive degrees rotate **Clockwise**. Negative degrees rotate **Counter-Clockwise**.\n"
            "   - **The Leveling Rule**: Estimate the angle required to make the object's primary axis (or text) perfectly vertical or horizontal.\n"
            ...
            "6. **Mixed Sets**: If an image contains multiple distinct objects, use the `extracted_objects` parameter in `finalize_processed_item`. Each object MUST have its own `crop_box` and optional `rotation`.\n"
            ...
            "**Visual Reasoning**: I see a green power drill tilted about 10 degrees right. I identify 'Bosch' branding and 'PSB 1800' model text. Coordinates: [100, 200, 800, 600]. To level it, I need a -10 degree rotation.\n"
            "**Action**:\n"
            ...
            "**Visual Reasoning**: I see two objects. Object 1 is a hammer at [50, 50, 400, 300], level. Object 2 is a screwdriver at [450, 50, 900, 300], rotated about 45 degrees clockwise. To level it, I need a -45 degree rotation.\n"
            "**Action**:\n"
